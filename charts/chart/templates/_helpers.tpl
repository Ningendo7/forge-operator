...
*/}}
{{- define "forge-operator.fullname" -}}
...
*/}}
{{- define "forge-operator.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "forge-operator.resourceName" -}}
{{- $fullname := include "forge-operator.fullname" .context }}
{{- $suffix := .suffix }}
...
{{- else }}
{{- include "forge-operator.resourceName" (dict "suffix" "controller-manager" "context" .) }}
{{- end }}
{{- end }}
